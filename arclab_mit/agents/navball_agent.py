...
class LLMAgent(KSPDGBaseAgent):
    ...
    def get_action(self, observation, sun_position=None):
        ...
        if recommendation != [ft, rt, dt, self.duration]:
            print("Recommendation: " + str(recommendation))
            print("Action: " + str([ft, rt, dt, self.duration]))
            exit (0)
        else:
            print("Recommendation and action are the same")
...
def execute_agent():
    ...
    print("Model: " + os.environ['BASE_MODEL'])
